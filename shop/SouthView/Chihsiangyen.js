...
export default class Chihsiangyen extends Component<Props> {
        ...
        return (
            <ScrollView style={styles.container}>
                ...
                <Text style={styles.textView}>
                  從鵝鸞鼻乘船約需40分鐘的時間。它是一座海底的大礁石，海流強勁、變化大。水底珊瑚種類多、數量龐大，魚類豐富、數量極多。唯海流平靜時才適合潛水，且下水前須有完善的潛水計劃，才能行之。只適合經驗豐富的高級潛水員從事潛水活動。
                </Text>
