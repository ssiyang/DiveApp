...
export default class Dabaisha extends Component<Props> {
        ...
        return (
            <ScrollView style={styles.container}>
                ...
                <Text style={styles.textView}>
                  大白沙浮潛、潛水區位於綠島南側，它也是綠島規劃的三大潛點之一，此潛點同樣規劃有機車位、涼亭、海中生態解說圖及浮潛、潛水步道等設施。此潛點較特殊它由一月到四月份是開放漁獵的，雖有相關業者與有心人士於此餵食，但因有部分時間開放漁獵，因此此潛點魚族數量比柴口、石朗略少，魚族也較怕人。
                </Text>
