...
export default class Yutzuhu extends Component<Props> {
        ...
        return (
            <ScrollView style={styles.container}>
                ...
                <Text style={styles.textView}>
                  沿著環島公路至7K處轉入柚子湖，由公路至柚子湖道路落差極大應注意行駛。此潛點分為左右二側，此區域海底地形高低起伏變化大，常見大型迴游性魚類，此潛點為高階浮潛景點，較常見當地人來此浮潛，不熟此潛點的遊客應避免到此從事浮潛活動。
                </Text>
