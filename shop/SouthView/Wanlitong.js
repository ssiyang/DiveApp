...
export default class Wanlitong extends Component<Props> {
        ...
        return (
            <ScrollView style={styles.container}>
                ...
                <Text style={styles.textView}>
                  萬里桐的海底相貌是由不規則的巨型珊瑚群礁所組成的，呈現出海溝、豁谷及隧道峽谷等不同地形。從水深3米起即可見到石珊瑚、軟珊瑚、海綿、海百合等，越往深處可發現巨型海扇。在礁石與沙地相會的地形，常可見到魟魚等沙棲魚類。最大深度約22米左右，適合體能較佳的中高級潛水員從事潛水活動。
                </Text>
