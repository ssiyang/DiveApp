...
export default class Jialeshuei extends Component<Props> {
        ...
        return (
            <ScrollView style={styles.container}>
                ...
                <Text style={styles.textView}>
                  從停車場邊下水，下水潛有一段銳利的礁石群，要通過頗為辛苦，此潛點因臨太平洋，風浪較大、水流也較強勁。海底為海蝕溝與平台地形交錯，最大深度約18米以上，水底有大量的石珊瑚、大海扇以及為數眾多的龍蝦群，是別處少見的。此潛點適合有經驗的中高級潛水員從事潛水活動。
                </Text>
