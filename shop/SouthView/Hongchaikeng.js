...
export default class Hongchaikeng extends Component<Props> {
        ...
        return (
            <ScrollView style={styles.container}>
                ...
                <Text style={styles.textView}>
                  紅柴坑的沿岸潛點在入水時大多必須經過一段地形崎嶇的礁石群，才得以到達入水點。水底景象可見大量的石珊瑚、大海扇及色彩繽紛的毛槍蟲。由於紅柴外海有一座定置漁網，因此潛水員常可見到大型的迴游性魚類出沒。此潛場最大深度約22米左右，適合體能較佳的各級潛水員從事潛水活動。
                </Text>
