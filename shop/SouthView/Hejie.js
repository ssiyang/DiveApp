...
export default class Hejie extends Component<Props> {
        ...
        return (
            <ScrollView style={styles.container}>
                ...
                <Text style={styles.textView}>
                  合界沿線海底地形變化大、落差明顯，形成多處大峽谷地形。海底有大量的海百合，色彩種類極多。此潛點尤以海蛇出沒著稱，潛水員應秉持與海洋生物共存共榮的態度與海中生物相處。此海域因落差大，潛水員在下潛時應確實做好耳壓平衡。最大深度約24米左右，適合中高級潛水員從事潛水活動。
                </Text>
