...
export default class Siangjiaobay extends Component<Props> {
        ...
        return (
            <ScrollView style={styles.container}>
                ...
                <Text style={styles.textView}>
                  香蕉灣是墾丁地區的一個小漁村，此處也是船潛活動的大本營。從港邊入水，離岸70米後水深約10米左右，此地形是呈現出廣闊的珊瑚礁平台，海底景象由海蝕礁岩形成的海溝，有大量的石珊瑚，魚類以大型砲彈魚與刺河魨為大宗。適合夜潛與各級潛水員從事潛水活動。
                </Text>
