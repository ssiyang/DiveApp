...
export default class Shanhaikang extends Component<Props> {
        ...
        return (
            <ScrollView style={styles.container}>
                ...
                <Text style={styles.textView}>
                  山海港是一座天然的避風港，因為關山的天然屏障，即使東北季風吹起，也可以潛水，極適合初級潛水員從事潛水訓練。最大深度約22米左右，水中能見度有時可達到30米。向外延伸約50米有一座獨立礁石，是一群有心的潛水人定點餵魚區，深度約22米，有成群的金花鱸、四線笛鯛、鰻魚及大量的熱帶魚。此潛點適合各級潛水員從事潛水活動。
                </Text>
