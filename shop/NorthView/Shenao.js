...
export default class Shenao extends Component<Props> {
        ...
        return (
            <ScrollView style={styles.container}>
                ...
                <Text style={styles.textView}>
                  深澳漁港是漁船進出花瓶嶼、彭加嶼、基隆嶼的進出港。從油庫左側進入行進約100公尺，右側沿岸都是不錯的潛點，走到盡頭（要有相當的體能），是一個突出外海的岬角，此處水深約25米左右，海底落差大，常有大型迴游性魚類出現。
                </Text>
