...
export default class Nanwan extends Component<Props> {
        ...
        return (
            <ScrollView style={styles.container}>
                ...
                <Text style={styles.textView}>
                  南灣位於本島最南端的兩個突出的岬角中間，一年四季都充滿著戲水的人潮，此地以沙質地地形為主。水底能見度不甚良好，但海底景觀有其特色。入水後由沙岸左側下潛行進，以石珊瑚為大宗，岩壁上也有為數不少的海百合。最大深度約18米左右，須特別注意的是此處水上機車出入頻繁，潛水員在上升時應小心。適合各級潛水員從事潛水活動。
                </Text>
