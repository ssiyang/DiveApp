...
export default class Shuangshihyen extends Component<Props> {
        ...
        return (
            <ScrollView style={styles.container}>
                ...
                <Text style={styles.textView}>
                  雙獅岩浮潛點位於蘭嶼的北邊母雞岩的右側；雙獅岩為兩座狀似獅子的大礁岩，分為左獅與右獅。左側潛點海底地形呈平緩向下延伸型態，最大深度約38m，地形變化不大，淺水區極適合初級浮潛員活動；右側浮潛點地形變化較大，水流亦較強，浮潛新鮮人應避免進入。右側潛點時而可見大型迴游性魚類現蹤。
                </Text>
