...
export default class Badouzi extends Component<Props> {
        ...
        return (
            <ScrollView style={styles.container}>
                ...
                <Text style={styles.textView}>
                  由八斗子過平浪橋走到盡頭，此處為過去的垃圾掩埋場，〝垃圾場潛點〞因而得名，現名為潮境公園。由掩埋場大門旁右側水泥梯下去，由於有將近20公尺的落差，加上路面崎嶇不平，故行進須特別小心。此潛點最大深度約25米左右，由於上下潛點不易，浮潛、潛水員出入較少，海底還保留大量的軟珊瑚群，因此有北部的海底秘密花園之稱。
                </Text>
