...
export default class Houbihu extends Component<Props> {
        ...
        return (
            <ScrollView style={styles.container}>
                ...
                <Text style={styles.textView}>
                  位於後壁湖的核三場出水口潛點，是墾丁地區聞名的戲水區，每到戲水旺季，此處總是吸引大量的親水人潮。海底3米起到最大深度16米左右分布著大量的石珊瑚與各式各樣的軟珊瑚，也不時可以發現其他海域以不多見的五爪硨蟝貝。要注意的是此潛點左側接近出水口，要小心強勁的出水口水流。適合各級浮潛員、潛水員從事活動。
                </Text>
