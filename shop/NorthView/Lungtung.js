...
export default class Lungtung extends Component<Props> {
        ...
        return (
            <ScrollView style={styles.container}>
                ...
                <Text style={styles.textView}>
                  龍洞灣公園游泳池外側，此潛點堪稱是北台灣浮潛、潛水活動的搖籃，最大深度約24米左右，是一個天然的避風海灣，海底景觀由不規則塊狀礁盤、平台及沙地等地形構成。魚類生態富變化，管口魚、角鰈、藍雀鯛、小丑魚等各式各樣熱帶魚都可在此見到。
                </Text>
